...
import { ChatIcon, HomeIcon, RupeeIcon, WrenchIcon, color, font, shadow } from '@dwellm8/mobile-shared';
...
export default function TabsLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="pay" options={{ tabBarIcon: tab(RupeeIcon), tabBarLabel: label('Pay') }} />
      <Tabs.Screen name="requests" options={{ tabBarIcon: tab(WrenchIcon), tabBarLabel: label('Requests') }} />
