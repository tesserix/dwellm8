...
reaches it: 0008 effective dating and temporal queries ([#9](https://github.com/tesserix/dwellm8/issues/9)),
0010 lease lifecycle ([#11](https://github.com/tesserix/dwellm8/issues/11)),
0013 KYC data handling ([#17](https://github.com/tesserix/dwellm8/issues/17)),
0014 database topology and RPO/RTO ([#25](https://github.com/tesserix/dwellm8/issues/25)).
